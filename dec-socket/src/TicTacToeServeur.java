...
public class TicTacToeServeur{
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            connexion = new ServerSocket(50000);
            System.out.println("Attachement serveur sur port 50000");
        } catch (IOException e) {
        ...
        String nom1 = joueurActuel.datainput().readUTF();
